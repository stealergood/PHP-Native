...
<footer class="site-footer">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <ul class="social-icons">
                    ...
                    <li><a class="whatsapp" href="https://wa.me/6282116154550?text=Halo JoFe Bakery..."><i
    ...
    <style>
        .site-footer {
            background: linear-gradient(to bottom right, #6C5B7B, #355C7D);
            padding: 45px 0 20px;
            font-size: 15px;
            line-height: 24px;
            color: #f2f2f2;
